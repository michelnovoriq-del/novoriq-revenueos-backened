...
type CheckoutFlow = 'beta' | 'e2e';

const CHECKOUTS: Record<CheckoutFlow, { baseUrl: string; planId: string }> = {
    beta: {
...
export const createCheckoutUrl = (req: AuthRequest, res: Response): void => {
    const flow = req.body?.flow as CheckoutFlow | undefined;

...
echo "[🔧] Engineering correction: Installing dependencies & fixing TypeScript strictness..."

# 1. Install the missing axios package
npm install axios

# 2. Patch the webhook to enforce strict string typing
...
export const handleStripeWebhook = async (req: Request, res: Response): Promise<void> => {
    try {
        // THE FIX: Explicitly cast as a string so TypeScript stops panicking
...
echo "[✅] Patched. Booting backend server..."
npm run dev
